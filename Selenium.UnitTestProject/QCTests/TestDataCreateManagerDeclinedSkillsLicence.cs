...
namespace Selenium.UnitTestProject
{
    ...
    class CreateManagerDeclinedSkillsLicence
    {         
        ...
        public void CreateManagerDeclinedSkillsLicenceTest()
        {
            using (IWebDriver driver = WebDriverManager.WebDriverManager.GetWebDriverForConfig())
            {
                ...
                AlterSkillsLicencePage.quoteATextBox(driver).SendKeys("4444.44");
                ...
                ShowManagerSkillsLicencePage.selectDeclineSkillsLicenceButton(driver).Click();
