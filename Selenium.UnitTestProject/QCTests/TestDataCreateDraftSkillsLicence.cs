...
namespace Selenium.UnitTestProject
{
    ...
    class CreateDraftSkillsLicence
    {         
        ...
        public void CreateDraftSkillsLicenceSmokeTest()
        {
            using (IWebDriver driver = WebDriverManager.WebDriverManager.GetWebDriverForConfig())
            {
                ...
                AlterSkillsLicencePage.quoteATextBox(driver).SendKeys("1111.11");
                ...
                AlterSkillsLicencePage.clickOnDraftButton(driver);
                string actualValue7 = DashboardPage.getTextForHeader(driver);
                Assert.IsTrue(actualValue7.Contains("SKILLS LICENCES"), actualValue7 + " doesn't contain 'SKILLS LICENCES'");
            }
        }
